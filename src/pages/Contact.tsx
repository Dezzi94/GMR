    ...
    <div className="min-h-screen">
      ...
      <div className="flex-1 flex items-center justify-center min-h-[60vh] bg-white">
        <div className="max-w-3xl mx-auto text-center py-24 px-4">
          ...
          <h2 className="text-4xl font-bold mb-12">Australia</h2>
          
          <div className="flex flex-col items-center space-y-8">
            <div className="flex items-start space-x-3">
              <svg className="w-5 h-5 mt-1 text-[#ff813a] flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
              </svg>
              <p className="text-base text-black">47 Macquarie Street, Gracemere,<br />Queensland 4702</p>
            </div>

            <div className="flex items-center space-x-3">
              <svg className="w-5 h-5 text-[#ff813a] flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
