      ...
      <div className="bg-gray-50 py-12">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <p className="text-xl text-gray-800 font-medium leading-relaxed">
            If you would like to get a quote, please contact us using the information below.
          </p>
        </div>
      </div>
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col space-y-8 max-w-xs mx-auto">
              <div className="flex items-start space-x-4">
                <svg className="w-5 h-5 text-[#ff813a] flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
